...
//    ]
    ...
    func sameArtistSubView() {
        ...
        self.webView.frame = CGRectMake(0, 20, max_w, max_h/2)
        self.webView.delegate = self
        self.view.addSubview(self.webView)
        
        var url : NSURL = NSURL.URLWithString("https://www.youtube.com/watch?feature=player_detailpage&v=\(bestYouTubeId)")
...
//        var bestYouTubeId = lastfmRequest.getBestTrackYoutubeId(artistName)
        var similarArtists2 = lastfmRequest.getSimilarArtist(nextView.artistName)
        var bestYouTubeId = lastfmRequest.getBestTrackYoutubeId(nextView.artistName)
